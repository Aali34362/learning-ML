...
namespace DeepLearning_ImageClassification.ImageClassification.Predict;

public static class PredictProgram
{
    public static void PredictMain()
    {
        const string assetsRelativePath = @"ImageClassification.Predict/assets";
        var assetsPath = PathFind.GetAbsolutePath(assetsRelativePath);
