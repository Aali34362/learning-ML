...
{
    private static string AppPath => PathFind.GetProjectRootPath();
    ...
    private static string TrainDataPath = PathFind.GetAbsolutePath(TrainDataRelativePath);
    private static string TestDataPath = PathFind.GetAbsolutePath(TestDataRelativePath);

    private static string BaseModelsRelativePath = @"/MLModels";
    private static string ModelRelativePath = $"{BaseModelsRelativePath}/TaxiFareModel.zip";
    private static string ModelPath = PathFind.GetAbsolutePath(ModelRelativePath);
