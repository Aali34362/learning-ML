...
class Program
{
    private static string currentDirectory = PathFind.GetProjectRootPath();
    private static string TRAIN_DATA_FILEPATH = Path.Combine(currentDirectory, @"\Data\taxi-fare-train.csv");
    private static string TEST_DATA_FILEPATH = Path.Combine(currentDirectory, @"\Data\taxi-fare-test.csv");
