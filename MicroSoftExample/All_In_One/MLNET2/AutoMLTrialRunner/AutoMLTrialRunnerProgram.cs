...
public static class AutoMLTrialRunnerProgram
{
    public static void AutoMLTrialRunnerMain()
    {
        ...
        TrialResult textClassificationExperimentResults = experiment.RunAsync(tcCts.Token).GetAwaiter().GetResult();
