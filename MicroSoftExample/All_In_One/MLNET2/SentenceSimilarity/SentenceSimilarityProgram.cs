...
public static class SentenceSimilarityProgram
{
    public static void SentenceSimilarityMain()
    {
    ...
    private static void Evaluate(IDataView predictions, string actualColumnName, string predictedColumnName)
    {
        var actual =
