...
public static class AutoMLEstimatorsProgram
{
    public static void AutoMLEstimatorsMain()
    {

        // Initialize MLContext
        MLContext ctx = new MLContext();

        var dataPath = PathFind.GetAbsolutePath(@"\Data\taxi-fare-train.csv");
        ...
        TrialResult experimentResults = experiment.RunAsync(cts.Token).GetAwaiter().GetResult();
