...
public static class PredictorProgram
{
    public static void PredictorMain()
    {
        string assetsPath = string.Empty;////GetAbsolutePath(@"../../../assets");
        string trainOutput = string.Empty;////GetAbsolutePath(@"../../../../CreditCardFraudDetection.Trainer/assets/output");
