...
class Program
{
    ...
    static string originalDataDirectoryPath = PathFind.GetAbsolutePath(originalDataDirectoryRelativePath);
    static string originalDataPath = PathFind.GetAbsolutePath(originalDataReltivePath);
    static string preparedDataPath = PathFind.GetAbsolutePath(preparedDataReltivePath);
