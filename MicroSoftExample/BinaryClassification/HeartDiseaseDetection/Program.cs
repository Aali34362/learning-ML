...
public class Program
{
    ...
    {
        string fileNameTrainData = "HeartTraining.csv";
        FileInfo fTrainData = new FileInfo(fileNameTrainData);
        string fileDirTrainData = $"{fTrainData.Directory!.Parent!.Parent!.Parent!.ToString()}/Data/HeartTraining.csv";
        TrainDataPath = fileDirTrainData;

        string fileNameTestDataPath = "HeartTraining.csv";
        FileInfo fTestDataPath = new FileInfo(fileNameTestDataPath);
        string fileDirTestDataPath = $"{fTestDataPath.Directory!.Parent!.Parent!.Parent!.ToString()}/Data/HeartTest.csv";
        TestDataPath = fileDirTestDataPath;

        string fileNameModelPath = "HeartTraining.csv";
        FileInfo fModelPath = new FileInfo(fileNameModelPath);
        string fileDirModelPath = $"{fModelPath.Directory!.Parent!.Parent!.Parent!.ToString()}/Data/HeartClassification.zip";
        ModelPath = fileDirModelPath;
