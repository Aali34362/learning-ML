...
internal static class Program
{
    ...
    {
        string fileNameTrainDataPath = "wikipedia-detox-250-line-data.tsv";
        FileInfo fTrainDataPath = new FileInfo(fileNameTrainDataPath);
        string fileDirTrainDataPath = $"{fTrainDataPath.Directory!.Parent!.Parent!.Parent!.ToString()}/Data/wikipedia-detox-250-line-data.tsv";
        TrainDataPath = fileDirTrainDataPath;

        string fileNameTestDataPath = "wikipedia-detox-250-line-test.tsv";
        FileInfo fTestDataPath = new FileInfo(fileNameTestDataPath);
        string fileDirTestDataPath = $"{fTestDataPath.Directory!.Parent!.Parent!.Parent!.ToString()}/Data/wikipedia-detox-250-line-test.tsv";
        TestDataPath = fileDirTestDataPath;

        string fileNameModelPath = "SentimentModel.zip";
        FileInfo fModelPath = new FileInfo(fileNameModelPath);
        string fileDirModelPath = $"{fModelPath.Directory!.Parent!.Parent!.Parent!.ToString()}/MLModels/SentimentModel.zip";
        ModelPath = fileDirTestDataPath;
