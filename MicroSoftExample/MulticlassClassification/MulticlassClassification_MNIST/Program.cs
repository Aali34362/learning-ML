...
class Program
{
    ...
    private static string TrainDataPath = PathFind.GetAbsolutePath(TrianDataRealtivePath);
    private static string TestDataPath = PathFind.GetAbsolutePath(TestDataRealtivePath);
